  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6">
      <div className="relative w-24 h-24 mb-6">
        ...
        <div className="absolute inset-0 border-4 border-accent-r-light rounded-full animate-spin border-t-transparent"></div>
      </div>
      
      <h2 className="text-2xl font-bold mb-2">Fetching Match History</h2>
      <p className="text-subtitle mb-4">Loading {totalMatches} matches...</p>
