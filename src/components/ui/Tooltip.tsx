      ...
      <div className="w-80 text-left p-1">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <div className="text-sm font-semibold text-gold-light">{tooltipData.name}</div>
          </div>
          {tooltipData.totalCost !== undefined && tooltipData.totalCost > 0 && (
            <div
              className="text-sm font-semibold ml-2 flex items-center gap-1"
        ...
        {tooltipData.description && tooltipData.description.trim() !== '' && (
          <>
            <div className="text-xs text-gray-300 leading-relaxed break-words mb-2">{formattedDescription}</div>
